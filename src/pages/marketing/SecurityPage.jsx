...
const SecurityPage = () => {
    return (
        <MarketingLayout>
            ...
            <section className="py-24 px-6 bg-white overflow-hidden relative border-b border-border-light">
                ...
                <div className="max-w-7xl mx-auto text-center relative z-10">
                    ...
                    <h1 className="text-5xl md:text-8xl font-black text-text-primary tracking-tighter leading-[0.9] mb-10">
                        Security is our <br className="hidden md:block"/> <span className="text-brand-primary italic">DNA.</span>
                    </h1>
                    <p className="text-xl text-text-secondary max-w-2xl mx-auto mb-12 leading-relaxed font-medium">
                        At FlowBoard, we maintain the highest standards of data security and privacy. 
                        We don't just follow compliance; we engineer our entire stack for the safety of your information.
                    </p>
            ...
            <section className="py-32 px-6 bg-bg-secondary/30 border-b border-border-light overflow-hidden">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative p-12 bg-text-primary rounded-[64px] shadow-3xl text-white font-mono text-sm space-y-6">
                                <div className="flex items-center justify-between border-b border-white/10 pb-4">
                                   ...
                                   <span className="text-[10px] font-black uppercase text-white/30 tracking-widest">Network Monitor</span>
                                </div>
                                <div className="space-y-2">
                                   ...
                                   <div className="flex justify-between text-brand-secondary">
                                      ...
                                      <span className="font-black text-xs px-2 bg-brand-secondary/20 rounded">ENABLED</span>
                                   </div>
            ...
            <section className="py-32 px-6 bg-white overflow-hidden">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center max-w-3xl mx-auto mb-24 space-y-6">
                        <Lock size={48} className="mx-auto text-brand-primary" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        <div className="p-12 bg-bg-secondary/30 rounded-[48px] border border-transparent hover:border-brand-primary/20 transition-all space-y-8">
                            ...
                            <div className="flex items-center gap-4 text-xs font-black uppercase tracking-widest text-text-tertiary">
                               <Shield size={16} className="text-brand-primary" /> Verified AES-256 standard
                            </div>
                        </div>
                        <div className="p-12 bg-bg-secondary/30 rounded-[48px] border border-transparent hover:border-brand-primary/20 transition-all space-y-8">
                            ...
                            <div className="flex items-center gap-4 text-xs font-black uppercase tracking-widest text-text-tertiary">
                               <Globe size={16} className="text-brand-primary" /> Forced TLS 1.3 / HTTPS
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-32 px-6 bg-text-primary text-white overflow-hidden text-center relative">
                <div className="absolute inset-0 opacity-10 pointer-events-none">
                   <div className="absolute top-0 left-1/4 w-1/2 h-full bg-gradient-to-b from-brand-primary to-transparent blur-[120px]"></div>
                </div>
                <div className="max-w-4xl mx-auto space-y-12 relative z-10">
                    <Eye size={64} className="mx-auto text-brand-secondary animate-pulse" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-12">
                        {[
                            ...
                            <div key={i} className="p-8 bg-white/5 border border-white/5 rounded-[40px] text-left">
            ...
            <section className="py-32 px-6 bg-white overflow-hidden border-b border-border-light">
                <div className="max-w-7xl mx-auto text-center">
                    <div className="text-center max-w-3xl mx-auto mb-20 space-y-6">
                        <Terminal size={48} className="mx-auto text-text-tertiary" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="p-10 bg-bg-secondary/30 rounded-[48px] border border-transparent hover:border-brand-primary/10 transition-all group">
                                <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center text-brand-primary mx-auto mb-8 shadow-sm group-hover:bg-brand-primary group-hover:text-white transition-all">
                                    {item.icon}
                                </div>
                                <span className="text-[10px] font-black uppercase tracking-widest text-brand-primary mb-4 block">{item.label}</span>
            ...
            <section className="py-24 px-6 bg-white">
                <div className="max-w-4xl mx-auto bg-bg-secondary/30 rounded-[64px] p-24 text-center space-y-12 relative overflow-hidden">
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -z-10 text-[30rem] font-black text-brand-primary/5 select-none">99.99%</div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6 pt-6">
                        <button className="btn btn-primary !rounded-2xl !px-12 !py-6 !text-xl font-black shadow-2xl shadow-brand-primary/20 flex items-center gap-3">
                           <Globe size={24} /> Visit Trust Center
                        </button>
                        <button className="btn btn-secondary !rounded-2xl !px-12 !py-6 !text-xl font-black bg-white">Report Security Issue</button>
                    </div>
                </div>
            </section>
        </MarketingLayout>
