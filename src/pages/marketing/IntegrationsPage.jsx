      ...
      <section className="py-24 px-6 bg-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto text-center relative">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="h-14 px-8 flex items-center justify-center bg-brand-primary text-white text-sm font-black uppercase tracking-widest rounded-2xl">Explore Marketplace</button>
            <button className="h-14 px-8 flex items-center justify-center bg-bg-secondary text-text-primary text-sm font-black uppercase tracking-widest rounded-2xl">Read API Docs</button>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20 px-4 md:px-0">
             ...
             <p className="text-base md:text-lg text-text-secondary leading-relaxed font-medium">Our growing library of native integrations means you're just a few clicks away from a unified workspace.</p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 md:gap-8 mb-20 px-4 md:px-0">
            {[
              ...
              <div key={i} className={`aspect-square flex flex-col items-center justify-center p-6 rounded-[32px] border border-border-light hover:shadow-xl transition-all duration-500 cursor-pointer group ${app.color}`}>
                  <div className="w-14 h-14 bg-white rounded-2xl shadow-sm mb-4 group-hover:scale-110 transition-transform flex items-center justify-center p-3 animate-in fade-in zoom-in duration-700">
