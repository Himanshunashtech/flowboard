...
const GuidesPage = () => {
    return (
        <MarketingLayout>
            ...
            <section className="py-24 px-6 bg-gradient-to-b from-bg-secondary/30 to-white text-center border-b border-border-light overflow-hidden">
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6">
                        <button className="btn btn-primary !px-12 !py-6 !text-lg !rounded-[24px] font-black shadow-2xl shadow-brand-primary/20">Read Latest Guide</button>
                        <button className="btn btn-secondary !px-12 !py-6 !text-lg !rounded-[24px] font-black">Browse by Topic</button>
                    </div>
                </div>
            </section>
            ...
            <section className="py-32 px-6 bg-white">
                <div className="max-w-7xl mx-auto">
                    <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-20">Master your workflow.</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        {[
                            ...
                            <div key={i} className="group p-12 bg-bg-secondary/20 rounded-[48px] border border-transparent hover:border-brand-primary/20 hover:bg-white hover:shadow-2xl transition-all duration-500 cursor-pointer">
                                <div className="flex items-center gap-6 mb-10">
                                    <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center text-brand-primary group-hover:bg-brand-primary group-hover:text-white transition-all shadow-sm">
                                        {guide.icon}
                                    </div>
                                    <span className="text-xs font-black uppercase tracking-widest text-text-tertiary">{guide.category} Masterclass</span>
                                </div>
                                <h3 className="text-3xl font-bold mb-6 group-hover:text-brand-primary transition-colors">{guide.title}</h3>
                                <p className="text-lg text-text-secondary leading-relaxed font-medium mb-10">{guide.desc}</p>
                                <span className="text-sm font-black uppercase tracking-[0.2em] text-text-tertiary group-hover:text-brand-primary transition-colors flex items-center gap-3">Start Reading Guide <ArrowRight size={16} /></span>
                            </div>
                        ))}
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                        <div className="space-y-10">
                            ...
                            <div className="grid grid-cols-2 gap-8">
                                <div>
                                    <p className="text-4xl font-black text-brand-secondary mb-1">40%</p>
                                    <p className="text-xs font-bold uppercase tracking-widest text-white/40">Cost Reduction</p>
                                </div>
                                <div>
                                    <p className="text-4xl font-black text-brand-secondary mb-1">2.4x</p>
                                    <p className="text-xs font-bold uppercase tracking-widest text-white/40">Release Speed</p>
                                </div>
                            </div>
                            <button className="btn btn-primary !rounded-2xl !px-10 !py-4 font-bold !bg-white !text-brand-primary">Download Case Study PDF</button>
                        </div>
                        <div className="aspect-square bg-white/5 rounded-[64px] border border-white/10 p-12 relative">
                            <div className="absolute inset-0 bg-gradient-to-br from-brand-secondary/20 to-transparent"></div>
                            <div className="h-full border border-white/10 rounded-[48px] flex items-center justify-center">
                                <BarChart3 size={100} className="text-brand-secondary opacity-30" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-32 px-6 bg-white overflow-hidden border-b border-border-light">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center max-w-3xl mx-auto mb-20 space-y-6">
                        ...
                        <h2 className="text-5xl font-bold tracking-tight">The Flow Masterclass.</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="p-10 bg-bg-secondary/30 rounded-[40px] text-center space-y-6 border border-transparent hover:border-brand-primary/20 transition-all">
                                ...
                                <h4 className="text-2xl font-bold">{m.title}</h4>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                        <div className="order-2 lg:order-1 relative">
                            <div className="p-10 bg-white rounded-[48px] border border-border-light shadow-2xl space-y-8">
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 rounded-2xl bg-success/10 text-success flex items-center justify-center"><Check size={24} /></div>
                                    <h4 className="font-bold text-xl">Strategy of the week</h4>
                                </div>
                                <div className="space-y-4">
                                    <p className="text-text-secondary font-medium leading-relaxed border-l-4 border-brand-primary pl-6 py-2 italic text-lg">
                                ...
                                <div className="flex items-center justify-center p-4 bg-bg-secondary rounded-2xl text-[10px] font-black uppercase tracking-widest text-text-tertiary">
                        ...
                        <div className="order-1 lg:order-2 space-y-10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <input type="email" placeholder="email@example.com" className="flex-1 px-8 py-5 bg-bg-secondary border border-border-light rounded-[24px] focus:outline-none focus:ring-4 focus:ring-brand-primary/5 transition-all font-bold placeholder:text-text-tertiary" />
                                <button className="btn btn-primary !rounded-[24px] !px-10 font-bold">Join Weekly</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-32 px-6 bg-white">
                <div className="max-w-4xl mx-auto bg-brand-primary rounded-[64px] p-24 text-center text-white relative overflow-hidden group">
                    <div className="absolute inset-0 bg-gradient-to-br from-brand-secondary/40 to-transparent"></div>
                    <div className="relative z-10 space-y-12">
                        <Star size={48} className="mx-auto text-warning animate-pulse" />
                        <h2 className="text-5xl md:text-7xl font-bold tracking-tighter leading-none">Flow Performance Audit.</h2>
                        <p className="text-xl text-white/70 max-w-xl mx-auto font-medium">
                            Download our free self-assessment tool to identify bottlenecks in your current 
                            team workflow and get immediate recommendations.
                        </p>
                        <button className="btn bg-white text-brand-primary hover:bg-white/95 !rounded-[24px] !px-12 !py-6 !text-xl font-black shadow-2xl transition-all hover:scale-105 flex items-center justify-center gap-4 mx-auto">
                            <Download size={24} /> Get the Audit Tool (PDF)
                        </button>
                    </div>
                </div>
            </section>
