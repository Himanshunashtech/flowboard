...
const CommunityPage = () => {
    return (
        <MarketingLayout>
            ...
            <section className="py-24 px-6 bg-white overflow-hidden relative">
                ...
                <div className="max-w-7xl mx-auto text-center relative z-10">
                    ...
                    <div className="flex flex-wrap justify-center gap-6">
                        <button className="btn btn-primary !px-12 !py-6 !text-lg !rounded-[24px] font-black shadow-2xl shadow-brand-primary/20">Join the Slack Community</button>
                        <button className="btn btn-secondary !px-12 !py-6 !text-lg !rounded-[24px] font-black">Explore Discussion Forum</button>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={i} className={`p-10 bg-bg-secondary/30 rounded-[48px] border border-transparent transition-all cursor-pointer hover:shadow-2xl hover:scale-105 group ${item.color}`}>
                                <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mx-auto mb-8 text-current shadow-sm group-hover:bg-current group-hover:text-white transition-all">
                                    {React.cloneElement(item.icon, { size: 32 })}
                                </div>
                                <h3 className="text-2xl font-bold mb-2 text-center text-text-primary group-hover:text-current transition-colors">{item.name}</h3>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                        <div className="space-y-10">
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    <div key={i} className="flex items-center gap-6 p-6 bg-white rounded-[32px] border border-border-light shadow-sm hover:shadow-xl transition-all cursor-pointer group">
                                        <div className="text-center w-12 border-r border-border-light pr-6">
                                            <p className="font-black text-brand-primary text-sm uppercase leading-none">{e.date.split(' ')[0]}</p>
                                            <p className="font-black text-text-primary text-lg">{e.date.split(' ')[1]}</p>
                                        </div>
                                        <div className="flex-1">
                                            <h4 className="font-bold text-lg group-hover:text-brand-primary transition-colors">{e.event}</h4>
                                            <p className="text-xs font-bold text-text-tertiary uppercase tracking-widest">{e.location}</p>
                                        </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative aspect-square bg-white rounded-[64px] border border-border-light shadow-2xl overflow-hidden shadow-black/5">
                                ...
                                <div className="absolute bottom-12 left-12 text-white">
                                    <h4 className="text-2xl font-bold mb-2">FlowCon 2025 Highlight</h4>
                                    <p className="text-white/70 font-medium">2,500+ attendees from 40 countries.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-32 px-6 bg-white overflow-hidden">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center max-w-3xl mx-auto mb-20 space-y-6">
                        <Award size={48} className="mx-auto text-warning" />
                        <h2 className="text-5xl font-bold tracking-tight">Become a Flow Ambassador.</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        {[
                            ...
                            <div key={i} className="text-center space-y-6">
                                <div className="w-20 h-20 bg-warning/10 rounded-[32px] flex items-center justify-center text-warning mx-auto mb-8">
                                    {item.icon}
                                </div>
                                <h3 className="text-2xl font-bold">{item.title}</h3>
                                <p className="text-text-secondary leading-relaxed font-medium px-8">{item.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-32 px-6 bg-text-primary text-white overflow-hidden border-y border-white/10">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                        <div className="relative">
                            <div className="grid grid-cols-2 gap-6">
                                {[1, 2, 3, 4].map(i => (
                                    <div key={i} className="aspect-video bg-white/5 rounded-3xl border border-white/10 flex items-center justify-center group cursor-pointer hover:border-brand-primary transition-colors">
                                        <Zap size={32} className="opacity-10 group-hover:opacity-100 transition-opacity text-brand-primary" />
                                    </div>
                                ))}
                            </div>
                            <div className="absolute -top-12 -left-12 p-8 bg-brand-primary rounded-[32px] text-white shadow-2xl">
                                <p className="text-xs font-black uppercase tracking-[0.2em] mb-1">Total Templates</p>
                        ...
                        <div className="space-y-10">
                            ...
                            <button className="btn btn-primary !rounded-2xl !px-10 !py-4 font-bold">Browse Gallery</button>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-32 px-6 bg-white">
                <div className="max-w-4xl mx-auto text-center space-y-12">
                    <h2 className="text-5xl md:text-7xl font-bold tracking-tighter leading-none">Ready to <br/><span className="text-brand-primary underline decoration-dashed underline-offset-[16px] decoration-4">find your flow?</span></h2>
                    <p className="text-xl text-text-secondary font-medium">Whether you're looking for help, templates, or just networking—there's a place for you here.</p>
                    <div className="flex flex-col sm:flex-row justify-center gap-6 pt-8">
                        <button className="btn btn-primary !px-12 !py-6 !rounded-[24px] !text-lg font-black shadow-2xl shadow-brand-primary/20">Sign Up & Join Community</button>
                        <button className="btn btn-secondary !px-12 !py-6 !rounded-[24px] !text-lg font-black bg-white">Read Community Guidelines</button>
                    </div>
                </div>
            </section>
        </MarketingLayout>
